...
public class TopPanel extends JPanel
{
	...
	public panels.ChromatographyProperties jxpanelChromatographyProperties = null;
	public panels.ColumnProperties jxpanelColumnProperties = null;
	public panels.GeneralProperties jxpanelGeneralProperties = null;
	/**
	...
	private void initialize() 
	{
	    ...
	    CSH.setHelpIDString(jxpanelChromatographyProperties.jtxtMeOHFraction, "controls.meohfraction");
	    CSH.setHelpIDString(jxpanelChromatographyProperties.jlblMeOHFraction, "controls.meohfraction");
	    CSH.setHelpIDString(jxpanelChromatographyProperties.jsliderMeOHFraction, "controls.meohfraction");
	...
	private JXPanel getControlPanel() 
	{
		if (jControlPanel == null) 
		{
		    ...
		    jxpanelChromatographyProperties = new panels.ChromatographyProperties();
		    jxpanelChromatographyProperties.setPreferredSize(new Dimension(254,254));
		    ...
		    jxpanelGeneralProperties = new panels.GeneralProperties();
		    ...
		    jxpanelColumnProperties = new panels.ColumnProperties();
